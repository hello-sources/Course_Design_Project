...
a.pack()
s = tk.Scale(window, label='time setting', from_=0, to=100, orient=tk.HORIZONTAL, length=200, showvalue=0,tickinterval=2, resolution=10, command=print_selection).pack()
