...
public class LandFrame extends JFrame {
	...
	class LandButtonActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (username.equals("AAA")) {// 查看是否为默认用户登录
				if (inputPassword.equals("123456")) {// 查看密码是否为默认密码
					...
					JOptionPane.showMessageDialog(null,
							"默认用户“AAA”的登录密码为“123456”！", "友情提示",
							JOptionPane.INFORMATION_MESSAGE);// 弹出提示
					passwordField.setText("123456");// 将密码设置为默认密码
				}
			} else {
