...
public interface UserMapper { 
	...
	public boolean deletePythonHistory(int id);
	public boolean deleteNetHistory(int id);
	public boolean deleteJavaHistory(int id);
	public boolean deleteCppHistory(int id);
	public boolean deleteCHistory(int id);
}
